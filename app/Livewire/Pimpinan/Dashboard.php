...
class Dashboard extends Component
{
    ...
    public function render()
    {
        ...
        // Hapus Log Aktivitas ($activities) karena tidak ditampilkan lagi di Pimpinan
        ...
        $data = [
            ...
            'highlights' => [
                [
                    ...
                    'icon' => 'star',
                    'color' => 'text-yellow-500' // Akan di-override CSS agar terlihat di bg gelap
                ],
                [
