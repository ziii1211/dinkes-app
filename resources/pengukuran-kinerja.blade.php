                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-6">
                        ...
                        <div class="border border-gray-100 rounded-lg p-4 bg-gray-50 relative" x-data="{ open: false, search: '' }">
                            ...
                            <button @click="open = !open" @click.outside="open = false" type="button" class="flex items-center justify-between w-full bg-white border border-gray-200 text-gray-800 text-lg font-bold py-1 px-3 rounded hover:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-200 transition-all">
                                <span>{{ $tahun }}</span>
                                <svg class="w-4 h-4 text-gray-400 ml-2 transition-transform duration-200" :class="{'rotate-180': open}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="overflow-x-auto rounded-lg border border-gray-100 min-h-[300px]">
                        <table class="w-full text-left text-sm whitespace-nowrap md:whitespace-normal">
                            ...
                            <tbody class="divide-y divide-gray-100 text-gray-700">
                                ...
                                <tr class="bg-blue-50 border-b border-blue-100">
                                    <td colspan="7" class="px-6 py-3 font-bold text-gray-800 flex items-start gap-2 whitespace-normal">
                                        <svg class="w-4 h-4 text-blue-500 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 21v-8a2 2 0 012-2h14a2 2 0 012 2v8M3 13l6-6m0 0l6 6m-6-6v12"></path>
                                        </svg>
                                        {{ $sasaran->sasaran }}
                                    </td>
                                </tr>
                                ...
                                @else
                                <tr>
                                    <td colspan="7" class="px-6 py-12 text-center text-gray-400 italic">Belum ada data Perjanjian Kinerja (Final) untuk tahun {{ $tahun }}.</td>
                                </tr>
                                @endif
                            </tbody>
                        </table>
                    ...
                    <div class="overflow-x-auto rounded-lg border border-gray-100 min-h-[200px]">
                        <table class="w-full text-left text-sm whitespace-nowrap md:whitespace-normal">
                            ...
                            <tbody class="divide-y divide-gray-100 text-gray-700">
                                ...
                                @empty
                                <tr>
                                    <td colspan="6" class="px-6 py-12 text-center text-gray-400 italic">Belum ada data Rencana Aksi.</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
                    ...
                    <div class="overflow-x-auto rounded-lg border border-gray-100 min-h-[200px]">
                        <table class="w-full text-left text-sm whitespace-nowrap md:whitespace-normal">
                            ...
                            <tbody class="divide-y divide-gray-100 text-gray-700">
                                ...
                                @empty
                                <tr>
                                    <td colspan="5" class="px-6 py-12 text-center text-gray-400 italic">Belum ada data penjelasan.</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
            ...
            <div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm transition-opacity p-4" x-data>
                <div class="bg-white rounded-xl shadow-2xl w-full max-w-lg overflow-hidden transform transition-all">
                    <div class="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-white">
                        ...
                        <button wire:click="closeAturJadwal" class="text-gray-400 hover:text-gray-600 transition-colors focus:outline-none"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                            </svg></button>
                    </div>
            ...
            <div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm transition-opacity p-4" x-data>
                <div class="bg-white rounded-xl shadow-2xl w-full max-w-lg overflow-hidden transform transition-all">
                    <div class="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-white">
                        ...
                        <button wire:click="closeTambahAksi" class="text-gray-400 hover:text-gray-600 transition-colors focus:outline-none"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                            </svg></button>
                    </div>
                    <div class="p-6 space-y-4">
            ...
            <div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm transition-opacity p-4" x-data>
                <div class="bg-white rounded-xl shadow-2xl w-full max-w-lg overflow-hidden transform transition-all">
                    <div class="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-white">
                        ...
                        <button wire:click="closeRealisasi" class="text-gray-400 hover:text-gray-600 transition-colors focus:outline-none"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                            </svg></button>
                    </div>
            ...
            <div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm transition-opacity p-4" x-data>
                <div class="bg-white rounded-xl shadow-2xl w-full max-w-lg overflow-hidden transform transition-all">
                    <div class="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-white">
                        ...
                        <button wire:click="closeTanggapan" class="text-gray-400 hover:text-gray-600 transition-colors focus:outline-none"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                            </svg></button>
                    </div>
                    <div class="p-6 space-y-4">
            ...
            <div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm transition-opacity p-4" x-data>
                <div class="bg-white rounded-xl shadow-2xl w-full max-w-lg overflow-hidden transform transition-all">
                    <div class="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-white">
                        ...
                        <button wire:click="closeRealisasiAksi" class="text-gray-400 hover:text-gray-600 transition-colors focus:outline-none"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                            </svg></button>
                    </div>
                    <div class="p-6 space-y-6">
            ...
            <div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm transition-opacity p-4" x-data>
                <div class="bg-white rounded-xl shadow-2xl w-full max-w-2xl overflow-hidden transform transition-all">
                    <div class="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-white">
                        ...
                        <button wire:click="closeTambahPenjelasan" class="text-gray-400 hover:text-gray-600 transition-colors focus:outline-none"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                            </svg></button>
                    </div>
                    <div class="p-6 space-y-4">
