<div>
    ...
    <div class="space-y-6">
        ...
        {{-- BAGIAN 3: VISUALISASI POHON KINERJA (Diagram) --}}
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm">
        <div class="bg-white rounded-xl shadow-2xl w-full max-w-2xl mx-4">
            <div class="px-6 py-4 border-b border-gray-100 flex justify-between items-center">
                <h3 class="text-lg font-bold text-gray-800">{{ $isEditMode ? 'Edit Data' : ($isChild ? 'Tambah Anak' : 'Buat Pohon Baru') }}</h3>
    ...
    {{-- MODAL 2: INDIKATOR (Ini yang penting agar tombol berfungsi) --}}
    @if($isOpenIndikator)
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm">
                ...
                @else
                    <div>
                        ...
                        <select wire:model="cross_sumber_id" class="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm">
                            <option value="">-- Ambil dari Data Pohon Kinerja --</option>
