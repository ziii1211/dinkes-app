            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 md:p-6">
                ...
                <div class="mt-3 pt-3 border-t border-gray-100">
                    ...
                    <div class="text-gray-600 text-xs leading-relaxed">
                        ...
                        {{-- PERBAIKAN DI SINI: Mengganti karakter bullet fisik dengan &bull; --}}
                        <div class="mb-1 flex items-start"><span class="mr-2">&bull;</span><span>{{ $outcome->outcome }}</span></div>
                        @empty
                                            ...
                                            <div class="py-1">
                                                ...
                                                <button wire:click="pilihPenanggungJawab({{ $output->id }})" @click="open = false" class="group flex w-full items-center px-4 py-2 text-sm text-yellow-600 hover:bg-yellow-50 transition-colors">
                                                    <svg class="mr-3 h-4 w-4 text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                                                    </svg>Penanggung Jawab
                                                </button>

                                                {{-- 2. Sub Kegiatan (LINK YANG SUDAH DIPERBAIKI) --}}
