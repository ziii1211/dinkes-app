                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            @if ($jabatans->count() > 0)
                                ...
                                @endforeach
                            @else
                                {{-- COLSPAN DISESUAIKAN: Jika Admin 3 kolom, selain admin 2 kolom --}}
                                <tr><td colspan="{{ auth()->user()->hasRole('admin') ? 3 : 2 }}" class="p-8 text-center text-gray-500 italic bg-gray-50">Data jabatan kosong.</td></tr>
                            @endif
                        </tbody>
                    </table>
                </div>
                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            @if ($pegawais->count() > 0)
                                ...
                                @endforeach
                            @else
                                {{-- COLSPAN DISESUAIKAN: Jika Admin 6 kolom, selain admin 5 kolom --}}
                                <tr><td colspan="{{ auth()->user()->hasRole('admin') ? 6 : 5 }}" class="p-8 text-center text-gray-500 italic bg-gray-50">Belum ada data pegawai.</td></tr>
                            @endif
                        </tbody>
                    </table>
                </div>
