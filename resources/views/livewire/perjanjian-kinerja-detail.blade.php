            ...
            <div class="p-6">
                <div class="flex justify-between items-center mb-6">
                    <div class="flex items-center text-sm text-gray-600">
                        ...
                        <select class="border border-gray-300 rounded px-2 py-1 text-sm focus:ring-blue-500 focus:border-blue-500 bg-white">
                            <option>10</option><option>25</option>
                        </select>
                    </div>
                    <div class="flex items-center">
                        <span class="mr-2 text-sm text-gray-600">Search:</span>
                        <input type="text" wire:model.live="search" class="border border-gray-300 rounded px-3 py-1 text-sm focus:ring-blue-500 focus:border-blue-500 w-64 bg-gray-50" placeholder="Cari keterangan...">
                    </div>
                </div>
                    ...
                    <table class="w-full text-left text-sm">
                        <thead class="bg-white text-gray-500 border-b border-gray-100 uppercase tracking-wider text-xs font-semibold">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-center w-48">Menu</th>
                            </tr>
                        </thead>
