<div class="min-h-screen bg-gray-100 p-6 font-sans text-gray-600">
    ...
    <div class="grid grid-cols-1 xl:grid-cols-12 gap-6 mb-8">
        ...
        <!-- KOLOM KIRI: WELCOME CARD (30% Width - Disesuaikan agar lebih proporsional) -->
        <div class="xl:col-span-4 bg-white rounded-xl shadow-sm border border-gray-200 p-8 flex flex-col items-center justify-center text-center relative overflow-hidden">
            ...
            <div class="mb-6 transform hover:scale-105 transition-transform duration-500">
                <img src="{{ asset('logo-prov-kalsel.png') }}" alt="Logo Kalsel" class="h-36 w-auto object-contain drop-shadow-md">
            </div>
        ...
        <!-- KOLOM KANAN: KONTEN UTAMA (70% Width - Disesuaikan) -->
        <div class="xl:col-span-8 flex flex-col gap-6">
            
            <!-- 1. CARD SELAMAT DATANG ADMIN -->
            <div class="bg-white p-5 rounded-xl shadow-sm border border-gray-200 flex flex-col md:flex-row justify-between items-center gap-4">
                <div class="flex items-center gap-4 w-full md:w-auto">
                    <!-- Icon User -->
                    <div class="h-12 w-12 rounded-full bg-gray-50 flex items-center justify-center flex-shrink-0">
                        <svg class="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                        </svg>
                        <div class="absolute bg-blue-600 rounded-full border-2 border-white h-3 w-3 -mt-3 -mr-3"></div>
                    </div>
            ...
            <!-- 3. CARD INDIKATOR KINERJA UTAMA (REVISED) -->
            <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <!-- Card 1: Indeks Pembangunan Manusia -->
                    ...
                    <!-- Card 2: Tingkat Pengangguran Terbuka -->
                    <div class="bg-gray-50 rounded-xl p-5 border border-gray-200 hover:border-yellow-400 transition-colors group">
                        ...
                        <!-- Progress Bar (Inverse/Negative Goal) -->
                        <div class="w-full bg-gray-200 rounded-full h-2.5 mb-1">
                            <!-- Capaian 96.39% berarti progress barnya sisa 96.39% dari target yang *lebih rendah* -->
                    ...
                    <div class="bg-gray-50 rounded-xl p-5 border border-gray-200 hover:border-green-400 transition-colors group">
                        ...
                        <!-- Progress Bar -->
                        <div class="w-full bg-gray-200 rounded-full h-2.5 mb-1">
                            <div class="bg-green-600 h-2.5 rounded-full" style="width: 100%"></div> <!-- Capped at 100% visually -->
                        </div>
                        <div class="flex justify-between text-xs font-medium">
    ...
    <!-- ROW 2: CHART SECTION (TETAP SAMA) -->
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div class="w-full">
            ...
            <div class="h-12"></div> <!-- Spacer for rotated labels -->
        </div>
