    ...
    <div class="bg-white shadow-xl rounded-[2.5rem] p-8 sm:p-12 border border-gray-100 relative z-10 space-y-10">
        ...
        <div class="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-6">
            ...
            <div class="flex flex-wrap gap-3">
                ...
                <a href="{{ route('perjanjian.kinerja.print', $pk->id) }}" target="_blank" class="inline-flex items-center px-5 py-2.5 bg-[#ffc107] hover:bg-[#e0a800] text-white text-sm font-bold rounded-lg shadow-sm transition-all hover:shadow-md">
