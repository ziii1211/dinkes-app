...
<button wire:click="downloadExcel" wire:loading.attr="disabled" class="px-4 py-2 bg-green-500 hover:bg-green-600 text-white text-sm font-medium rounded shadow-sm flex items-center transition-colors">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="text-sm text-gray-600 divide-y divide-gray-100">
                            ...
                            {{-- SASARAN (Termasuk Baris Anak Virtual) --}}
