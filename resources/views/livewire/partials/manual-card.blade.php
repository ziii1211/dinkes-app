                            ...
                            <tr class="border-b border-gray-200 bg-white hover:bg-gray-50 transition-colors">
                                ...
                                <td class="p-3 border-r border-gray-200 align-top">
                                    <textarea 
                                        ...
                                        class="w-full border-none bg-transparent focus:ring-0 text-sm p-1 resize-none overflow-hidden min-h-[50px] leading-relaxed placeholder-gray-400 font-medium text-gray-800" 
                                ...
                                <td class="p-2 border-r border-gray-200 align-top">
                                    <div class="flex gap-2">
                                        ...
                                        <textarea 
                                            ...
                                            x-data="{ resize() { $el.style.height = 'auto'; $el.style.height = $el.scrollHeight + 'px' } }"
                                            x-init="resize()" @input="resize()"
                                            class="w-full border border-gray-300 rounded text-xs p-2 focus:ring-blue-500 focus:border-blue-500 resize-none overflow-hidden min-h-[40px] leading-relaxed bg-gray-50 focus:bg-white transition-colors" 
                                    ...
                                    <div class="flex h-full items-stretch">
                                        ...
                                        <div class="w-1/2 p-1 border-r border-gray-200">
                                            <input type="text" 
                                                ...
                                                class="w-full h-full min-h-[40px] text-center text-sm font-semibold text-gray-700 border-transparent focus:ring-0 bg-transparent placeholder-gray-300" 
                                                placeholder="0">
                                        </div>
                                        {{-- Satuan --}}
                                        <div class="w-1/2 p-1">
                                            <input type="text" 
                                                ...
                                                class="w-full h-full min-h-[40px] text-center text-sm text-gray-600 border-transparent focus:ring-0 bg-transparent placeholder-gray-300" 
                                                placeholder="%">
                                        </div>
                                    </div>
                                </td>

                                {{-- Aksi Simpan & Hapus Indikator --}}
                                <td class="p-2 text-center align-middle">
                            ...
                            @if(isset($listJabatans) && count($listJabatans) > 0)
                                @foreach($listJabatans as $jab)
                                    @php
                                        ...
                                        $arrow = ($jab->level ?? 0) > 0 ? '↳ ' : '';
                                        // Styling opsional untuk level jabatan
